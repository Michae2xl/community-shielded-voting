...
- replace invite-based eligibility with cryptographic proof of membership
- let a voter prove eligibility without revealing personal identity
- reduce operator-side identity correlation beyond the current model
- move the system closer to a stronger private voting primitive
